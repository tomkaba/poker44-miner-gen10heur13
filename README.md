# poker44-miner-gen10heur13

Minimal release repository for model gen10heur13.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur13.git
cd poker44-miner-gen10heur13
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur13`.
- Static prediction threshold is `0.46`.
